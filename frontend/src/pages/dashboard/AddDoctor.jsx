...
export default function AddDoctor() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append("create_login", createLogin ? 1 : 0);
      if (createLogin) {
  ...
  return (
    <div className="flex bg-paper-dim min-h-screen">
      ...
      <div className="flex-1 ml-72">
        <Topbar title="Add Doctor" subtitle="Register a new doctor profile" />
        ...
        <div className="p-8">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h1 className="font-display text-3xl font-semibold text-ink">Add Doctor</h1>
          </div>
          ...
          <form onSubmit={handleSubmit} className="card p-8 max-w-3xl space-y-5">
            <div className="flex items-center gap-5 pb-2">
              ...
              <p className="text-muted text-sm">
                Upload a profile photo (optional), then fill in the doctor's
            ...
            <div className="rounded-xl border border-line p-4">
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                />
                <span className="text-ink text-sm font-medium">
                  Create a Doctor Portal login for this doctor
                </span>
              </label>
